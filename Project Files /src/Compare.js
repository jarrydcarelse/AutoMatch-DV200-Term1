...
const Compare = () => {
  ...
  useEffect(() => {
    axios
      .get("https://car-specs.p.rapidapi.com/v2/cars/makes", {
        headers: {
          "X-RapidAPI-Key":
            "9defac6222msh3cc12731b9775a7p1a1b56jsncd147c014d61",
  ...
  const fetchModels = async (makeId) => {
    const response = await axios.get(
      `https://car-specs.p.rapidapi.com/v2/cars/makes/${makeId}/models`,
      {
        headers: {
          "X-RapidAPI-Key":
            "9defac6222msh3cc12731b9775a7p1a1b56jsncd147c014d61",
  ...
  const fetchTrims = async (generationsId) => {
    const response = await axios.get(
      `https://car-specs.p.rapidapi.com/v2/cars/generations/${generationsId}/trims`,
      {
        headers: {
          "X-RapidAPI-Key":
            "9defac6222msh3cc12731b9775a7p1a1b56jsncd147c014d61",
  ...
  const fetchCarSpecs = async (trimsId) => {
    const response = await axios.get(
      `https://car-specs.p.rapidapi.com/v2/cars/trims/${trimsId}`,
      {
        headers: {
          "X-RapidAPI-Key":
            "9defac6222msh3cc12731b9775a7p1a1b56jsncd147c014d61",
        ...
        <div className="row">
          <div className="col-sm-12">
            <div className="home-section">
              <h1> AUTOMATCH</h1>
              <h2>How to Compare Cars</h2>
              <p>
                Follow these steps to compare cars and view their specifications
                side by side:
              </p>
              <ol>
                <li>
                  Select the make of the car from the "Make" dropdown list.
                </li>
                <li>
                  Once you've chosen the make, the "Model" dropdown will be
                  populated with available models for that make. Select the
                  desired model.
                </li>
                <li>
                  Next, choose the generation (year range) of the model from the
                  "Generation" dropdown list.
                </li>
                <li>
                  Finally, select the specific trim level of the car from the
                  "Trim" dropdown list.
                </li>
                <li>
                  Click on the "Add Car" button to add the selected car to the
                  comparison box.
                </li>
                <li>
                  Repeat the above steps to add another car for comparison if
                  desired.
                </li>
                <li>
                  The comparison box will display detailed specifications of the
                  selected cars, including engine specifications, body
                  dimensions, and fuel consumption data.
                </li>
                <li>
                  You can remove a car from the comparison box by clicking the
                  "Remove" button next to the car's details.
                </li>
              </ol>
              <p>Start comparing cars now and make informed decisions!</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="row">
          <div className="col-sm-6">
            <div className="comparebox">
              ...
              {ShowDataA ? (
                <>
                  <button className="removebutton" onClick={handleRemoveDataA}>
                    Remove
                  </button>
                  <br></br>
                  ...
                  <hr />
                  <p>
                    Capacity: <strong>{CapacityA} Cm3 </strong>
                  </p>
                  <p>
                    CylinderLayout: <strong>{CylinderLayoutA}</strong>
                  </p>
                  <p>
                    EmissionStandards: <strong>{EmissionStandardsA}</strong>
                  </p>
                  <p>
                    EngineHp: <strong>{EngineHpA} Hp </strong>
                  </p>
                  <p>
                    EngineHpRpm: <strong>{EngineHpRpmA}Rpm </strong>{" "}
                  </p>
                  <p>
                    EngineType: <strong>{EngineTypeA}</strong>
                  </p>
                  <p>
                    InjectionType: <strong>{InjectionTypeA}</strong>
                  </p>
                  <p>
                    MaximumTorque:<strong>{MaximumTorqueA} NM </strong>
                  </p>
                  <p>
                    NumberOfCylinders:<strong>{NumberOfCylindersA}</strong>{" "}
                  </p>
                  ...
                  <hr />
                  <p>
                    Body Type: <strong>{bodyTypeA}</strong>{" "}
                  </p>
                  <p>
                    Body length: <strong>{lengthA} mm</strong>{" "}
                  </p>
                  <p>
                    Body width: <strong>{widthA} mm</strong>{" "}
                  </p>
                  <p>
                    Body height: <strong>{heightA} mm</strong>{" "}
                  </p>
                  <p>
                    Wheel base: <strong>{wheelbaseA} mm</strong>{" "}
                  </p>
                  <p>
                    Curb Weight: <strong>{curbWeightA} Kg</strong>{" "}
                  </p>
                  <p>
                    full weight: <strong>{fullWeightA} Kg</strong>{" "}
                  </p>
                ...
                <>
                  ...
                  <button
                    ...
                    onClick={handleShowDataA}
                    disabled={disableAddButtonA}
                  >
                    Add Car
                  </button>
                </>
          ...
          <div className="col-sm-6">
            <div className="comparebox">
              ...
              {ShowDataB ? (
                <>
                  <button className="removebutton" onClick={handleRemoveDataB}>
                    Remove
                  </button>
                  ...
                  <hr />
                  <p>
                    Capacity: <strong>{CapacityB} Cm3 </strong>
                  </p>
                  <p>
                    CylinderLayout: <strong>{CylinderLayoutB}</strong>
                  </p>
                  <p>
                    EmissionStandards: <strong>{EmissionStandardsB}</strong>
                  </p>
                  <p>
                    EngineHp: <strong>{EngineHpB} Hp </strong>
                  </p>
                  <p>
                    EngineHpRpm: <strong>{EngineHpRpmB}Rpm </strong>{" "}
                  </p>
                  <p>
                    EngineType: <strong>{EngineTypeB}</strong>
                  </p>
                  <p>
                    InjectionType: <strong>{InjectionTypeB}</strong>
                  </p>
                  <p>
                    MaximumTorque:<strong>{MaximumTorqueB} NM </strong>
                  </p>
                  <p>
                    NumberOfCylinders:<strong>{NumberOfCylindersB}</strong>{" "}
                  </p>
                  ...
                  <hr />
                  <p>
                    Body Type: <strong>{bodyTypeB}</strong>{" "}
                  </p>
                  <p>
                    Body length: <strong>{lengthB} mm</strong>{" "}
                  </p>
                  <p>
                    Body width: <strong>{widthB} mm</strong>{" "}
                  </p>
                  <p>
                    Body height: <strong>{heightB} mm</strong>{" "}
                  </p>
                  <p>
                    Wheel base: <strong>{wheelbaseB} mm</strong>{" "}
                  </p>
                  <p>
                    Curb Weight: <strong>{curbWeightB} Kg</strong>{" "}
                  </p>
                  <p>
                    full weight: <strong>{fullWeightB} Kg</strong>{" "}
                  </p>
                ...
                <>
                  ...
                  <button
                    className="comparebutton"
                    onClick={handleShowDataB}
                    disabled={disableAddButtonB}
                  >
                    Add Car
                  </button>
                </>
